...
import com.kami.fileexplorer.util.ReadMimeTask;
...
public final class MimeTypes {
    ...
    public static MimeTypes mInstance = new MimeTypes();
    ...
    public void readData(Context context) {
        @SuppressLint("StaticFieldLeak") final ReadMimeTask task = new ReadMimeTask(context) {
            @Override
