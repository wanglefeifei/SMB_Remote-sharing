...
import com.kami.fileexplorer.cloud.CloudStreamer;
...
public abstract class StreamServer {
    ...
    public StreamServer( int port, File wwwroot ) throws IOException {
        Log.d(TAG, "wlf StreamServer: port = " + port + " wwwroot =" +wwwroot);
        myTcpPort = port;
        ...
        myThread = new Thread(() -> {
            try {
                while (true) {
                    ...
                    Log.d(TAG, "StreamServer: 11111" +accept);
    ...
    private class HTTPSession implements Runnable {
        ...
        private void handleResponse(Socket socket) {
            try {
                ...
                Log.d("wlf", "handleResponse: 3333" +is);
                if (is == null) return;
                ...
                Log.d(TAG, "wlf " +pre.toString());
                Log.d(TAG, "wlf Params: " + parms.toString());
                Log.d(TAG, "wlf Header: " + header.toString());
        ...
        private void decodeHeader(BufferedReader in, Properties pre, Properties parms, Properties header)
            ...
            try {
                ...
                Log.d("wlf", "decodeHeader: 4444 " + !st.hasMoreTokens() +" inLine "+ inLine);
                if (!st.hasMoreTokens())
                ...
                int qmi = uri.indexOf('?');
                Log.d("wlf", "decodeHeader: qmi " + qmi);
                if (qmi >= 0) {
                ...
                Log.d("wlf ", "decodeHeader: IOException ");
                sendError(socket, HTTP_INTERNALERROR, "SERVER INTERNAL ERROR: IOException: " + ioe.getMessage());
            }
        }
